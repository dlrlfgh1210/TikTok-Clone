...
import 'package:flutter_tiktok/features/inbox/view_models/messages_view_model.dart';
        ...
        title: ListTile(
          ...
          leading: const CircleAvatar(
            ...
            foregroundImage: NetworkImage(
              "https://avatars.githubusercontent.com/u/121213240?s=96&v=4",
            ),
            child: Text('기로'),
          ),
          title: Text(
                ...
                data: (data) {
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isMine =
                          message.userId == ref.watch(autoRepo).user!.uid;
                      return Row(
                        mainAxisSize: MainAxisSize.min,
